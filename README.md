...
Интернет-магазин платьев. Реализована возможность добавления товара в корзину, удаления товара из корзины, посчет общей стоимости товаров, поиск товара, сортировка товара по категориям, популярности, цене, алфавиту. Добавлена пагинация. Параметры фильтрации сохраняются в url. Также возможно просмотреть информацию о товаре на отдельной странице. Данные корзины сохраняются в LocalStorage. Добавлена возможность смены темы. Оптимизированы перерисовки некоторых компонентов (React.memo). Бандл разделен на чанки (React.lazy). Работа с данными осуществляется через mockAPI.
